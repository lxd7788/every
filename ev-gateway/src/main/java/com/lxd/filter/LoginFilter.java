...
import com.lxd.config.FilterProperties;
import com.lxd.config.JwtProperties;
...
//        return !isAllowPath(requestUri);
        ...
        for (String allpath:allowPaths){
            if (StringUtils.contains(requestUri,allpath)){
                return false;
            }
        }
        return true;
...
//    }
    ...
    public Object run() throws ZuulException {
        ...
        //4.校验
        String cookieNames = this.properties.getCookieName();
